"use client";
import '@/lib/mock/amplifyClient.mock';
import './login-updated.css';

import { useState, useEffect, useCallback } from 'react';
import { useRouter } from 'next/navigation';
import { signIn, signUp } from '@/lib/mock/auth-helpers.mock';
import { confirmSignUp as amplifyConfirmSignUp, fetchAuthSession } from '@/lib/mock/aws-amplify-auth-import.mock';
import { Amplify } from '@/lib/mock/aws-amplify.mock';
...
import { useAmplifyAuth, AmplifyUser } from '@/lib/mock/AmplifyAuthContext.mock';
...
export default function LoginClientPage() {
  ...
  const handleSignOut = async () => {
    try {
      ...
      if (safeAuthContext.isAuthenticated) {
        ...
        const auth = await import('@/lib/mock/aws-amplify-auth-import.mock');
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      const { signInWithRedirect } = await import('@/lib/mock/aws-amplify-auth-import.mock');
