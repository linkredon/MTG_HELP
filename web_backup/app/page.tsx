...
const MobileApp = () => {
  ...
  const tabs = [
    { id: 'painel', label: 'Dashboard', icon: HomeIcon },
    { id: 'colecao', label: 'Coleção', icon: Library },
    { id: 'decks', label: 'Decks', icon: Hammer },
    { id: 'favoritos', label: 'Favoritos', icon: Heart },
    { id: 'achievements', label: 'Conquistas', icon: Trophy },
    { id: 'regras', label: 'Regras', icon: BookOpen },
    { id: 'spoiler', label: 'Novidades', icon: Sparkles },
                ...
                <div className="mobile-tab-content active">
                  <div className="mobile-placeholder">
                    <div className="mobile-placeholder-content">
                      ...
                      <h2 className="mobile-placeholder-title">{tab.label}</h2>
                      <p className="mobile-placeholder-description">
                        Funcionalidade {tab.label.toLowerCase()} em desenvolvimento para mobile.
                      </p>
                    </div>
                  </div>
                </div>
