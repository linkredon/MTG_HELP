...
export default function LoginClientPage() {
  ...
  // Função para limpar autenticação e cookies
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Se o usuário já estava autenticado, apenas redirecionar
        if (result.alreadyAuthenticated) {
          console.log('Usuário já estava autenticado, redirecionando...');
          setSuccess('Você já está logado! Redirecionando...');
